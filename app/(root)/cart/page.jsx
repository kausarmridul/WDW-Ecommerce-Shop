      ...
      {items.length > 0 && (
        <div className="md:w-4/5 w-[95%] mx-auto grid grid-cols-1 xl:grid-cols-6 gap-12">
          <div className="rounded-lg shadow-md overflow-hidden xl:col-span-4">
            ...
            {items.map((item) => (
              <div key={item.id}>
                <div className="flex pb-6 mt-2 p-5 border-b-[1.5px] border-gray-700/25 items-center space-x-10">
                  <div>
                    <Image
                      src={item.image}
                      alt={item.title}
          ...
          <div className="xl:col-span-2">
            <div className="bg-indigo-950 sticky top-[15vh] p-6 rounded-lg">
              <h1 className="text-center my-8 text-white text-3xl font-semibold">
                Summary
              </h1>
              <div className="w-full h-[1.2px] bg-white/20" />
